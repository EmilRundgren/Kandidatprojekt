...
uiBorder    = 25;       % space between edge of figure and any uicontrol
winTopGap   = fonsterHojd*(4/10);       % gap between top of screen and top of figure **
winLeftGap  = fonsterBredd*(4.5/10);       % gap between side of screen and side of figure **
